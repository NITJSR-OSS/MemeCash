...
export default class Web3ContextProvider extends Component {
   ...
   async componentDidMount(){
          ...
          const memeFactoryContract = await new web3.eth.Contract(this.state.memeFactoryABI,'0xe0e85F3154438b3750dF1cA703B450Fd675796dA');
          this.setState({memeFactoryContract});
          memeFactoryContract.methods.getDeployedMemes().call()
                        .then((deployedMemes)=>{
